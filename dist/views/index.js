 ...
 */
var _a = __read((0, pondsocket_1.createContext)('IndexContext'), 2), homeConsumer = _a[0], homeProvider = _a[1];
 ...
 * To use the consumer, you must first import it from file where it was created
 */
var _b = __read((0, pondsocket_1.createContext)('SearchContext'), 2), searchConsumer = _b[0], searchProvider = _b[1];
 ...
 * To use the consumer, you must first import it from file where it was created
 */
var _c = __read((0, pondsocket_1.createContext)('TodoContext'), 2), todoConsumer = _c[0], todoProvider = _c[1];
 ...
 */
exports.Index = (0, pondsocket_1.LiveFactory)({
    routes: [{
            path: '/todo',
    ...
    onContextChange: function (name, provider, context, socket, _router) {
        ...
        if (name === 'ElapsedContext')
            ...
            socket.assign({
                ...
                reminders: context.manager.getReminders().filter(function (reminder) { return !reminder.completed; }).map(function (reminder) { return reminder.text; })
            });
        if (name === 'TodoContext') {
            var todos = context.todos.filter(function (todo) { return todo !== provider.todo; });
            if (provider.action)
    ...
    onEvent: function (event, _context, socket, _router) {
