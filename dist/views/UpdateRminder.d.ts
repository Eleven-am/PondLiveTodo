import { Reminder, ReminderManagerType } from "../controller/database";
 ...
 */
export declare const UpdateReminderModal: import("pondsocket").Constructor<import("pondsocket").LiveComponent<UpdateReminderAssigns>>;
export {};
