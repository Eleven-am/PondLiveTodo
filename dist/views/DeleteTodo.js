 ...
 */
exports.DeleteTodoModal = (0, pondsocket_1.LiveFactory)({
    routes: [],
    ...
    onEvent: function (event, context, socket, router) {
        ...
        if (event.type === 'deleteTodo') {
            ...
            if (todo) {
                database_1.database.splice(database_1.database.indexOf(todo), 1);
                /**
