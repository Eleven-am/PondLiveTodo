 ...
 */
var _a = __read((0, pondlive_1.createContext)({
    name: ''
 ...
 * To use the consumer, you must first import it from file where it was created
 */
var _b = __read((0, pondlive_1.createContext)({
    query: ''
 ...
 * To use the consumer, you must first import it from file where it was created
 */
var _c = __read((0, pondlive_1.createContext)({
    todo: '',
    action: false
 ...
 */
exports.Index = (0, pondlive_1.LiveFactory)({
    routes: [{
            path: '/todo',
